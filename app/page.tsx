      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <Image src="/bazawaza-logo.png" alt="BazaWaza Logo" width={32} height={32} className="object-contain" />
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <a href="#demo-section" className="text-muted-foreground hover:text-accent transition-colors">
              Demo
            </a>
...
// Client component for interactive hero section
      ...
      <div className="container mx-auto text-center max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-11 px-8 text-lg cursor-pointer"
          >
            Watch Demo
          </button>
...
// Server component for static problem section
...
function DemoSection() {
  return (
    <section id="demo-section" className="py-32 px-4">
...
// Server component for static features section
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="border-border">
            <CardHeader>
              ...
              <CardDescription>Never miss a call again with round-the-clock professional call handling</CardDescription>
            </CardHeader>
          </Card>
...
// Client component for interactive CTA section
function CTASection() {
  return (
...
// Main page component combining server and client components
